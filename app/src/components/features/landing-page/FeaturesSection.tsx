...
const FeaturesSection = () => {
    return (
        <section className="bg-brand-beige py-24 px-6 border-b border-slate-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {features.map((feature, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="w-12 h-12 rounded-2xl bg-brand-light-green text-brand-primary flex items-center justify-center mb-6">
